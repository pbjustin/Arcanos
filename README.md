...
- **AI-Managed Operations**: Fine-tuned GPT model (`REDACTED_FINE_TUNED_MODEL_ID`) controls all system operations
...
AI_MODEL=your-fine-tuned-model-id-here  # Default: REDACTED_FINE_TUNED_MODEL_ID
```
...
ROOT_OVERRIDE_TOKEN=REDACTED_ROOT_OVERRIDE_TOKEN
```
