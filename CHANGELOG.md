...
## 2026-03-03
- Docs: updated Railway deployment/healthcheck guidance (`/healthz`), added Responses+Tools continuation doc, refreshed quickstart/runbooks, removed stale autogenerated refactor notes.
## Overview
