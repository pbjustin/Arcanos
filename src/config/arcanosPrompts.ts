export const ARCANOS_PROMPTS = {
  ...
  reasoningLayer: 'You are GPT-5.2 reasoning layer. Refine and audit the response for clarity, alignment, and safety.'
};
...
export function buildMockArcanosResponse(prompt: string, fineTunedModel: string): string {
  ...
  return [
    ...
    '2. GPT-5.2 reasoning: Enhanced analysis and safety audit',
