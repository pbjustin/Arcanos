...
export class IntentAnalyzer {
  ...
  analyzeIntent(input: string): IntentAnalysisResult {
    ...
    if (
      ...
      normalizedInput.startsWith("check") ||
      normalizedInput.startsWith("run") ||
      normalizedInput.startsWith("how much") ||
      normalizedInput.startsWith("how busy") ||
    ...
    if (
      normalizedInput.startsWith("what is") ||
      normalizedInput.startsWith("how to") ||
      normalizedInput.startsWith("can you explain") ||
      normalizedInput.startsWith("tell me")
    ) {
      narrativeScore += 2;
    ...
    if (
      normalizedInput.includes("is this correct") ||
      normalizedInput.includes("is this right") ||
      normalizedInput.includes("does this work") ||
      normalizedInput.includes("is this valid")
    ) {
      auditScore += 2;
    ...
    if (totalScore === 0) {
      ...
      diagnosticScore > narrativeScore &&
      diagnosticScore > auditScore
    ) {
      intent = "DIAGNOSTIC";
