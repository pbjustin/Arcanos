...
export const CONTROL_PLANE_OPERATION_ALLOWLIST: readonly ControlPlaneOperationSpec[] = Object.freeze([
  ...
  },
  {
    ...
    kind: 'command',
    workflow: 'arcanos.mcp.documented_tools',
    requiredScopes: ['arcanos:read'],
    readOnly: true,
  ...
  },
  {
    ...
    provider: 'backend-api',
    description: 'Allow a whitelisted GPT identity to request Trinity routing without confirming route success.',
  ...
  },
  {
    ...
    provider: 'backend-api',
    description: 'Verify control-plane route metadata without treating whitelist membership as route confirmation.',
    kind: 'route-verify',
