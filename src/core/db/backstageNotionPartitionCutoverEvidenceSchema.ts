/**
 * Additive runtime-bootstrap contract paired with
 * migrations/20260830_backstage_notion_partition_cutover_evidence_v1.sql.
 */
export const BACKSTAGE_NOTION_PARTITION_CUTOVER_EVIDENCE_TABLE_DEFINITIONS = [
  String.raw`ALTER TABLE public.backstage_notion_partitioned_universe_heads
  ...
  END;
  $block$`,
  String.raw`CREATE TABLE IF NOT EXISTS public.backstage_notion_partition_cutover_evidence (
  ...
  String.raw`CREATE INDEX IF NOT EXISTS backstage_notion_partition_cutover_evidence_manifest_idx
