// Keep this runtime bootstrap contract byte-for-byte aligned with
// migrations/20260824_backstage_notion_partition_storage_v1.sql.
export const BACKSTAGE_NOTION_PARTITION_STORAGE_TABLE_DEFINITIONS = [
  String.raw`  BEGIN;
