...
The ARCANOS system now implements a sophisticated routing architecture that ensures ALL tasks are processed through the fine-tuned ARCANOS model (`ft:gpt-3.5-turbo-0125:personal:arcanos-v2:BxRSDrhH`) while conditionally leveraging GPT-5.1 for complex reasoning.
...
📊 [ROUTING SUMMARY] ARCANOS: ft:gpt-3.5-turbo-0125:personal:arcanos-v2:BxRSDrhH | GPT-5.1 Used: true
```
