...
| Temporary npm-audit platform-profile exception | Reviewed PR #1444 implementation commit `18d4db05e26f5c8488968f4918cf2d1ec991e978` removes the remaining exception registry and uses exact patched registry artifacts while preserving parent versions. Required exact-head CI and `All Checks Complete` passed; merge remains required. No deployment or production credit is inferred |
