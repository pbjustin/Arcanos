...
draft PR #1444. Other findings retain the prior 2026-08-12 evidence cutoff
...
| Temporary npm-audit platform-profile exception | Draft PR #1444 removes the remaining exception registry and uses exact patched registry artifacts while preserving parent versions. The initial candidate passed required CI and independent local review; the amended provenance/ledger head and merge remain required. No deployment or production credit is inferred |
