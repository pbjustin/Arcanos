...
- Only the separate credential-free job checks out the opted-in PR head, and it
  ...
  116-request harness and contract come from the trusted default-branch checkout.
