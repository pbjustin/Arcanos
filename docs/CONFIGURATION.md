...
| `TRINITY_REASONING_MAX_OUTPUT_TOKENS` | `8000` (commented) | Structured Responses ceiling for hidden reasoning plus visible JSON. Positive lower values are honored; larger values are clamped to `8000`. |
