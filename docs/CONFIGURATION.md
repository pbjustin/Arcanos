...
| `BOOKER_TOKEN_LIMIT` | `2400` (commented) | Standard Backstage Booker output budget, bounded by its `2400`-token cap. Ordinary Trinity callers remain capped at `1200`, and compact direct-answer prompts can use a smaller derived budget. |
