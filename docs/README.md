...
| [Backstage Booker Custom GPT](BACKSTAGE_BOOKER_CUSTOM_GPT.md) | Docs-as-contract | Purpose-bound exact-ID universe read and canon Action authentication, single-banner write approval, Builder setup, rotation, and rollback. |
