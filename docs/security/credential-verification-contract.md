...
The repository currently has 25 security-sensitive opaque comparison boundaries. The first seven have complete Phase 1 characterization; O-08 through O-20 received focused Phase 2A decision tests before migration, and O-21 through O-25 were added with focused boundary tests.
