-- The exact catalog guard is shared with the precheck. The verifier additionally
-- requires the index to exist; absence is an error after the concurrent phase.
...
BEGIN
  ...
  IF index_oid IS NULL
    ...
    RAISE EXCEPTION 'scope-read parent index is missing, unexpected, or invalid'
      USING ERRCODE = '42804';
  END IF;
END
$block$;
