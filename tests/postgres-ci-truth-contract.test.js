...
const POSTGRES_TEST_FILES = [
  ...
  'tests/integration/dag-token-accounting.pg18.integration.test.ts',
  'tests/dag-accounting-e2e.test.ts',
];
...
describe('required PostgreSQL CI truth contract', () => {
  it('uses one required-database sentinel for all sixteen PostgreSQL suites', () => {
