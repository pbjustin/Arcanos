...
async function testLegacyService() {
...
function printResults(name, metrics) {
    console.log(`\n📊 ${name} Results:`);
...
export { testUnifiedService, testLegacyService, testStreamingFeature, testFunctionCalling, runPerformanceTests };
