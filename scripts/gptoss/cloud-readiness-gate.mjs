...
export function buildCloudGate({
  ...
  const checks = {
    ...
    phase6ImplementationReady: readiness.phase6ImplementationReady === true,
    finalArchitectureReadinessReviewed: readiness.finalArchitectureReadinessReviewed === true,
  ...
  return {
    ...
    customGptReady,
    localControlledRuntimeReady,
    phase6ImplementationReady: checks.phase6ImplementationReady,
    finalArchitectureReadinessReviewed: checks.finalArchitectureReadinessReviewed,
