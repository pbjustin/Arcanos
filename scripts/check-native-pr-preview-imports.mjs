...
export const NATIVE_PR_PREVIEW_ALLOWED_GRAPH_FILES = Object.freeze([
  ...
  'src/services/gamingHtmlEvidence.ts',
  'src/services/gamingJsonEvidence.ts',
  ...
  'src/shared/gaming/gamingStructuredEvidencePreviewFixture.ts',
  'src/shared/gaming/gamingCurrentnessPreviewFixture.ts',
  'src/shared/gaming/gamingDocumentProjectionCore.ts',
  'src/shared/gaming/gamingEvidenceUnits.ts',
  'src/shared/gaming/gamingStructuralEvidence.ts',
...
const FILE_SPECIFIC_EXTERNAL_IMPORT_BINDINGS = new Map([
  ...
  ['src/services/gamingJsonEvidence.ts', new Map([
    ['node:crypto', new Set(['createHash:createHash'])],
    ['cheerio', new Set(['load:load'])],
  ])],
  ...
  ['src/shared/gaming/gamingCurrentnessAdapters.ts', new Map([
    ['node:crypto', new Set(['createHash:createHash'])],
  ])],
...
const CRITICAL_ENTRY_FILE_DIGESTS = new Map([
  ...
  ['src/shared/gaming/gamingCurrentnessPreviewFixture.ts', '2e88ec458b3b42f154f6ba4a8befa4d5484bff9263261481e648c1ebb0bf4c60'],
  ...
  ['src/shared/gaming/gamingHybridPolicyCore.ts', 'c5d6880decaba930fef369687a967fb2dbc30bdacc5d189dbd03a58f0d738702'],
  ...
  ['src/shared/gaming/gamingStoredEvidenceCore.ts', '77eaf56b226d06c10a0eba9b97a6b1f0ee2c34c1e2ffd93cd72f91acd32cedb1'],
  ...
  ['src/shared/gaming/gamingStructuralEvidence.ts', 'a1f27faf563a7e9c4c834ec6bf59c4c8616c1f3901ee8ccb8212be1adfdb6fdf'],
  ...
  [
    'scripts/start-railway-service.mjs',
    '166b16c70b7ff72dea14e1a24f815139b1c3e881244ceefade13037ee21ccef4',
  ],
  [
    'src/start-native-pr-preview.ts',
  ...
  [
    'src/shared/backstage/backstageActionPolicy.ts',
    'fd2cffd96fea53807a67a7bc767b8df540e2a2a599a65bf57980e03552170661',
  ],
  [
    'src/shared/backstage/backstageExecutionBudget.ts',
    'ae5c0317e24d0aff915cd1cc1922e603e98ae64f0d3d95d1924d16158aab39b6',
  ],
  [
    'src/shared/backstage/backstageBookerAccessAuthCore.ts',
