...
def build_tool_registry(contract: ProtocolContract) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _tool_definition(
            "tool.invoke",
            "Invoke a protocol-visible tool inside the active workspace binding.",
            command_schemas,
            False,
            ["tools:invoke"],
        ...
        _tool_definition_from_schema_ids(
            ...
            contract.tools["repo.listTree"].input["$id"],
            contract.tools["repo.listTree"].output["$id"],
            False,
            ["repo:read"],
            ["protocol-validation", "fs-read"],
            "workspace",
        ...
        _tool_definition_from_schema_ids(
            "repo.readFile",
            "Read UTF-8 file content from the active workspace root.",
            contract.tools["repo.readFile"].input["$id"],
            contract.tools["repo.readFile"].output["$id"],
            False,
            ["repo:read"],
            ["protocol-validation", "fs-read"],
            "workspace",
        ...
        _tool_definition_from_schema_ids(
            "repo.search",
            "Search text or symbols across the active workspace root.",
            contract.tools["repo.search"].input["$id"],
            contract.tools["repo.search"].output["$id"],
            False,
            ["repo:read"],
            ["protocol-validation", "fs-read"],
            "workspace",
        ...
        _tool_definition_from_schema_ids(
            "repo.getLog",
            "Read recent repository commits using read-only git inspection.",
            contract.tools["repo.getLog"].input["$id"],
            contract.tools["repo.getLog"].output["$id"],
            False,
            ["repo:read"],
            ["protocol-validation", "fs-read", "git-read"],
            "workspace",
        ...
        _tool_definition_from_schema_ids(
            "repo.getDiff",
            "Read a bounded git diff between two refs using read-only git inspection.",
            contract.tools["repo.getDiff"].input["$id"],
            contract.tools["repo.getDiff"].output["$id"],
            False,
            ["repo:read"],
            ["protocol-validation", "fs-read", "git-read"],
            "workspace",
