...
def test_contract_metadata_is_deterministic() -> None:
    """The shared fixture pins the exact lifecycle vocabulary and unique names."""
    ...
    unsupported_names = [case["name"] for case in CONTRACT["unsupportedScenarios"]]
...
def test_python_evaluator_matches_shared_lifecycle_contract(
    ...
    """Python must classify every enforceable lifecycle case like TypeScript."""
    plan = test_case["plan"]
